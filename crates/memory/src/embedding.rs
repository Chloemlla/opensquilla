...
pub trait EmbeddingProvider: Send + Sync {
    ...
    /// Embed a batch of texts. Default implementation loops over [`EmbeddingProvider::embed`],
...
///
/// On every [`EmbeddingProvider::embed`] call, the cache is consulted first using
